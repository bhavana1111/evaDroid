...
from model import completion_model
...
start_activity = "com.tripadvisor.tripadvisor/com.tripadvisor.android.ui.launcher.LauncherActivity"
package_name = "com.tripadvisor.tripadvisor"
...
def log_for_vectorization(clickables, history, button,reason):
    local_clickables = [
    ...
    with open("vector_log_local_llm.txt", "a", encoding="utf-8") as f:
...
while time.time() - start_time < max_duration:
    ...
    if selected and tap(selected["bounds"]):
        ...
        log_for_vectorization(clickables, history, button,reason)
        time.sleep(3)
        create_dump()
    else:
